    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_components.Dog, null),
                _react2.default.createElement('br', null),
                _react2.default.createElement('br', null),
                _react2.default.createElement(_components.Map, null),
                _react2.default.createElement('br', null),
                _react2.default.createElement('br', null),
...
Object.keys(_dog).forEach(function (key) {
...
var _lightningMessenger = __webpack_require__(17);
...
Object.keys(_lightningMessenger).forEach(function (key) {
  ...
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _lightningMessenger[key];
    }
  });
});
...
var Dog = exports.Dog = function (_Component) {
    ...
    function Dog(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Dog.__proto__ || Object.getPrototypeOf(Dog)).call(this, props));
    ...
    _createClass(Dog, [{
        key: 'onDogLoad',
        value: async function onDogLoad() {
            var response = await window.fetch('https://dog.ceo/api/breeds/image/random', {
                method: 'GET',
                mode: 'cors'
            });
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.onDogLoad.bind(this) },
                    'Load Dog'
                ),
                _react2.default.createElement('br', null),
                _react2.default.createElement('br', null),
                this.state.dog && _react2.default.createElement('img', { src: this.state.dog })
            );
        }
    }]);
...
var LightningMessenger = exports.LightningMessenger = function (_Component) {
    _inherits(LightningMessenger, _Component);

    function LightningMessenger(props) {
        _classCallCheck(this, LightningMessenger);

        var _this = _possibleConstructorReturn(this, (LightningMessenger.__proto__ || Object.getPrototypeOf(LightningMessenger)).call(this, props));
    ...
    _createClass(LightningMessenger, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
